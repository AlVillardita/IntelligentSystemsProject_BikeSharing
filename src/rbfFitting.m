function [ mse ] = rbfFitting( dataSet, features, samplesIntervals, targets, goal, spreadValues )
% rbfFitting.m: starting from a data set and its set of features, for each
% spread value defined in 'spreadValues', creates a RBF NN, tests it and 
% returns a column array of MSEs.
%
